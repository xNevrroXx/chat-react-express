...
const Authorization = () => {
    ...
    return (
        <Container xs justify="center">
            <Text h1 b size={50} css={{ textAlign: "center" }}>Sign in</Text>
            <Spacer y={3} />
            <Container display="flex" direction="column" as="form" css={{ width: "80%" }} onSubmit={formik.handleSubmit as any}>
                ...
                <Row justify="space-between" align="center" css={{ gap: 10 }}>
                    <Button type="button" bordered color="gradient">
                        <NavLink to={createPath({ path: ROUTE.REGISTRATION })}>Registration</NavLink>
                    </Button>
                    <Text b>or</Text>
                    <Button type="submit" css={{ width: "50%" }}>Login</Button>
                </Row>
            </Container>
        </Container>
    );
